                      ...
                      <form className="mx-1 mx-md-4">
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            ...
                            <label className="form-label" htmlFor="form3Example4cd" >confirmPassWord your password</label>
                        ...
                        <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                          <button type="button" className="btn btn-primary btn-lg" disabled={isRegister} onClick={handleRegister}>Register</button>
                        </div>
